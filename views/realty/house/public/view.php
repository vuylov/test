            ...
            <div class="col-md-5">
                ...
                <div class="detail-extra">
                    <table class="detail-extra-table">
                        <tr><td>Тип:</td><td><?=$object->housetype->name;?></td></tr>
...
<?php
$this->registerMetaTag(['name' => 'keywords', 'content' => 'частные дома в волгограде, продажа коттеджей в волгограде, продажа дач в волгограде, куплю коттедж в волгоград']);
$this->registerMetaTag(['name' => 'description', 'content' => $object->address]);
$this->title = 'Продается дом по адресу: '.$object->address;
?>