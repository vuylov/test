...
?>
<h1 class="part-title">Подселения</h1>
...
<div class="app-list">
    <?= ListView::widget([
        ...
        'itemView' => function ($model, $key, $index, $widget) use ($type){
            ...
            $template.='<div><strong>Кол-во комнат</strong>: '.$model->room->name.'</div>';
...
<?php
$this->registerMetaTag(['name' => 'keywords', 'content' => 'подселение в волгограде, купить подселение в волгограде, продать подселение, продать подселение в волгограде']);
$this->title = 'Подселения в Волгограде от Агенства жилья на Тулака';
?>
