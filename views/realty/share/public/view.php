...
<?php
$this->registerMetaTag(['name' => 'keywords', 'content' => 'подсление в волгограде, продажа подселения в волгограде, покупка подселения в волгограде']);
$this->registerMetaTag(['name' => 'description', 'content' => $object->address]);
$this->title = 'Продается подселение по адресу: '.$object->address;
?>