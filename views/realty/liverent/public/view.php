...
<?php
$this->registerMetaTag(['name' => 'keywords', 'content' => 'аренда жилья по адресу '.$object->address.',аренда жилья волгоград, аренда квартиры в волгограде, снять квартиру']);
$this->registerMetaTag(['name' => 'description', 'content' => $object->address]);
$this->title = 'Сдача жилья в аренду по адресу '.$object->address;
?>