...
?>
<h1 class="part-title">Аренда жилья</h1>
...
<?php
$this->registerMetaTag(['name' => 'keywords', 'content' => 'аренда жилья волгоград, аренда квартиры в волгограде, снять квартиру']);
$this->title = 'Аренда жилья и квартиры в Волгограде от Агенства жилья на Тулака';
?>