...
<?php
$this->registerMetaTag(['name' => 'keywords', 'content' => 'квартиры в волгограде, квартиры от застройщика, дешевые квартиры в волгограде']);
$this->title = 'Квартиры в Волгограде от Агенства жилья на Тулака';
?>